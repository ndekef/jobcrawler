...
use Goutte\Client;
use MyBotBundle\Entity\Job;
use MyBotBundle\Form\JobType;
...
class JobController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MyBotBundle:Job')->findAll();
     ...
     * @Method("POST")
     * @Template("MyBotBundle:Job:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MyBotBundle:Job')->find($id);
     ...
     * @Method("PUT")
     * @Template("MyBotBundle:Job:edit.html.twig")
     */
